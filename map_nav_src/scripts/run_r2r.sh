...
name=${name}-seed.${seed}
name=${name}-init.aug.45k.wuxian_0.6_0.8
...
CUDA_VISIBLE_DEVICES='3' python r2r/main_nav.py $flag  \
      --tokenizer bert \
      --bert_ckpt_file '/home/yangdongsheng/pycharm/VLN-DUET-main/datasets/R2R/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap-init.lxmert-aug.speaker/ckpts/model_step_355000.pt' \
      --eval_first
