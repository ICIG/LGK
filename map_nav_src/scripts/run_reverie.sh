...
outdir=${DATA_ROOT}/REVERIE/exprs_map/finetune/${name}1000_wuxian_1000_0.5_0.7_25.92
...
CUDA_VISIBLE_DEVICES='1' python reverie/main_nav_obj.py $flag  \
      --tokenizer bert \
      --resume_file /home/yangdongsheng/pycharm/VLN-DUET-main/datasets/REVERIE/exprs_map/finetune/dagger-clip768-seed.0wuxian_1000_0.5_0.7/ckpts/best_val_unseen \
      --test --submit